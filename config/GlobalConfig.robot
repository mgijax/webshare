...
YUI_JS_URL          ${YUI_URL}combo?${YUI_VERSION}/build/yahoo-dom-event/yahoo-dom-event.js&${YUI_VERSION}/build/dragdrop/dragdrop-min.js&${YUI_VERSION}/build/container/container-min.js&${YUI_VERSION}/build/datasource/datasource-min.js&${YUI_VERSION}/build/element/element-min.js&${YUI_VERSION}/build/datatable/datatable-min.js&${YUI_VERSION}/build/menu/menu-min.js&${YUI_VERSION}/build/resize/resize-min.js&${YUI_VERSION}/build/selector/selector-min.js&${YUI_VERSION}/build/tabview/tabview-min.js&${YUI_VERSION}/build/treeview/treeview-min.js
